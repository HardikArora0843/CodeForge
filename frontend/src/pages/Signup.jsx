      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            ...
            {showRequirements && (
              <motion.div
                className="mt-2 rounded-lg border border-gray-700/80 bg-gray-800/60 p-3"
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`text-xs font-medium ${
                    metCount === PASSWORD_REQUIREMENTS.length ? 'text-green-400' : 'text-gray-500'
                  }`}>
                      ...
                      >
                        <span
                          className={`flex h-4 w-4 shrink-0 items-center justify-center rounded-full ${
                            met ? 'bg-green-500/20' : 'bg-gray-700/60'
                          }`}
                        >
                          {met ? (
                            <Check className="h-2.5 w-2.5" strokeWidth={3} />
                          ) : (
                            <X className="h-2.5 w-2.5 opacity-60" strokeWidth={3} />
                          )}
                        </span>
                        {label}
                      </li>
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <a
            href="https://codeforge-98q6.onrender.com/user/auth/google"
